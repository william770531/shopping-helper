...
STORE_MAP = {
    "1": {
        "name": "南紡購物中心", # 這幾個字會傳給 AI，讓它知道現在是誰
...
def main():
    ...
    # 🔥 修改重點：傳送兩個參數 "資料夾" 和 "百貨名稱"
    store_name = target['name']
    os.system(f'python3 analyze.py "{dl_folder}" "{store_name}"')
